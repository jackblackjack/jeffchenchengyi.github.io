---
interact_link: content/machine-learning/00-math-for-ml/probability.ipynb
kernel_name: python3
has_widgets: false
...
We'll go through the probability theory you need to know to understand the theory behind machine learning algorithms, especially those in [Natural Language Processing](https://jeffchenchengyi.github.io/machine-learning/06-natural-language-processing/basics/README.html) and [Bayesian Methods](https://jeffchenchengyi.github.io/machine-learning/11-bayesian-methods/README.html).

### Table of Contents
1. [Basic Probability Theory](#basics)
2. [Probability Distributions](#distributions)



---
# Basic Probability Theory<a id='basics'></a>
